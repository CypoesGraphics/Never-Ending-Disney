...
[NED](https://github.com/CypoesGraphics/Never-Ending-Disney) is a chrome extension that improves the Disney+ experience for power users. It's features include:
...
![options](https://i.imgur.com/SVRdYyI.png)
